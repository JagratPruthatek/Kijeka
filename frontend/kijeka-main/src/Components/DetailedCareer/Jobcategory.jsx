...
function Jobcategory({ selected5, setSelected5 }) {
  ...
  return (
    <>
      <div className='dropdown w-[11rem] my-3 relative z-[1700]' >
        <div className='pt-[0.4rem] pb-[0.2rem] rounded-lg bg-white flex items-center justify-between w-full focus:ring-blue-500 p-4'
