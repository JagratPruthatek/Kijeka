...
function ByNewsDropdown({ selected7, setSelected7 }) {

  const [isActive5, SetIsActive5] = useState(false)
  const option7 = [' By News']
  return (
    <>
      <div className='dropdown w-[11rem] my-3 relative z-[1700]' >

        <div className='pt-[0.4rem] pb-[0.2rem] rounded-lg bg-[#ffff] flex items-center justify-between focus:ring-blue-500 p-4   '
