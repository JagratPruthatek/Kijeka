...
const BlogTwoImage = () => {
    return (
        <div className='flex flex-col'>
            ...
            <div>
                <img className='  w-[298px] h-[339px] mt-[44px] float-right mr-[23px] ' src="/images/BlogImage.png" alt="" />
                ...
                <p className='font-poppins font-normal  w-[384px]  text-[18px] leading-[27px] tracking-[5%] pt-[33px]' style={{ letterSpacing: "5%" }}> piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical </p>
            </div>
            <div className='flex  justify-center items-center'>
                <img className='  w-[298px] h-[339px] mt-[44px] float-right mr-[63px] ' src="/images/BlogImage.png" alt="" />
