...
const BlogMidImage = () => {
    return (
        <div className='flex flex-col'>
            ...
            <p className='text-[#000000] font-poppins font-bold text-[32px] leading-[48px] tracking-[4%] pt-[32px] ' style={{letterSpacing: "4%" }}>What is the use of Drum handling equipmets?</p>
            <p className='font-poppins  font-normal  text-[18px] leading-[27px] tracking-[5%] pt-[33px] ' style={{ letterSpacing: "5%" }}>Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.
            ...
            <div className='text-left flex flex-col justify-center items-center'>
                <img className='  w-[298px] h-[339px] mt-[44px] float-mid  ' src="/images/BlogImage.png" alt="" />
                <p className='font-poppins font-normal w-full  text-[18px] leading-[27px] tracking-[5%] pt-[33px] ' style={{ letterSpacing: "5%" }}>Latin words, combined with a handful of model sentence structures, to generate Lorem Ipsum which looks reasonable. The generated Lorem Ipsum is therefore always free from repetition, injected humour, or non-characteristic words etc.paragraphswordsbyteslistsStart with 'Loremipsum dolor sit amet...'
                </p>
                <p className='font-poppins font-normal  w-full  text-[18px] leading-[27px] tracking-[5%] pt-[30px]  ' style={{ letterSpacing: "5%" }}> piece of classical Latin literature from 45 BC, making it over 2000 years old. Richard McClintock, a Latin professor at Hampden-Sydney College in Virginia, looked up one of the more obscure Latin words, consectetur, from a Lorem Ipsum passage, and going through the cites of the word in classical </p>
            </div>
            <div>
                {/* publisher icon */}
                <PublisherIcon />
