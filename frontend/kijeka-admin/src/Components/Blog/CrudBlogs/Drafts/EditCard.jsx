...
const EditCard = () => {
  ...
  return (
    <div className="flex flex-col group w-full overflow-hidden  h-[229px] rounded-[10px] bg-[#FFFFFF] shadow-[0px_4px_20px_rgba(166,166,166,0.5)] border-[2px] hover:border-[#004B95] ">
      <div className="cursor-pointer  gap-[10px] h-[250px] flex justify-between   ">
        ...
        <div className="pr-[22px]">
          <div className="flex justify-between pt-[10px]">
            <p className="font-semibold text-[18px] w-[253px] text-left leading-[24px] tracking-[5%] duration-300 group-hover:scale-90">
              Drum handling Equipments Give better experience in work.{" "}
            </p>
            <div className=" flex flex-col gap-4 mr-[2px] mb-[15px]  duration-300  opacity-0  group-hover:opacity-100">
              <Edits />
          ...
          <p className="font-poppins group-hover:transform group-hover:scale-95  duration-300  text-left text-[11px] pt-[5px] tracking-[6%] font-medium w-[277px] overflow-hidden h-[105.67px]  ">
      ...
      <div className=" relative left-[416px] top-[13px] group-hover:translate-y-[-42px] flex items-center gap-2 ease-out duration-300  ">
        <i className="fa-solid fa-eye text-[#696969]"></i>
        <p className="text-[#696969]">28765</p>
      </div>
      <div className="flex rounded-[10px_0px_0px_10px] bg-[rgba(217,217,217,0.1)] backdrop-blur-sm w-[201px] h-[51px] group-hover:translate-y-[-76px] translate-y-[55px] ease-out duration-300  ">
        <img
