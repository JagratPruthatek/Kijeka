...
import Edits from "../Drafts/Edits";
      ...
      <div className="flex flex-col group w-[474px] overflow-hidden    h-[229px] rounded-[10px] bg-[#FFFFFF] shadow-[0px_4px_20px_rgba(166,166,166,0.5)] border-[2px] hover:border-[#004B95]  ">
        <div className="cursor-pointer  gap-[10px] h-[250px] flex justify-between   ">
          ...
          <div className="pr-[22px]">
            ...
            <p className="font-poppins group-hover:transform group-hover:scale-95  duration-300  text-left text-[10px] pt-[5px] tracking-[6%] font-medium w-[250px] overflow-hidden h-[97.67px]  ">
        ...
        <div className=" relative left-[350px] top-[4px] group-hover:translate-y-[-42px] flex items-center gap-2 ease-out duration-300  ">
          <button className="text-center bg-[#E52F2F] text-[13px] tracking-[6%] leading-[26.72px] font-semibold text-[#FFFFFF] font-poppins rounded-[5px] w-[106px] h-[31px]">
            Cancel
          </button>
        </div>
        <div className="flex items-center justify-center rounded-[10px_0px_0px_10px] bg-[rgba(217,217,217,0.1)] backdrop-blur-sm w-[200px] h-[42px] group-hover:translate-y-[-76px] translate-y-[55px] ease-out duration-300  ">
          <img
