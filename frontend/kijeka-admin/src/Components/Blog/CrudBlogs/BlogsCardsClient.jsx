  ...
  return (
    <>
      <div className="flex flex-col group w-[474px] overflow-hidden    h-[229px] rounded-[10px] bg-[#FFFFFF] shadow-[0px_4px_20px_rgba(166,166,166,0.5)] border-[2px] hover:border-[#004B95]  ">
        ...
        <div className=" relative left-[387px] top-[13px] group-hover:translate-y-[-42px] flex items-center gap-2 ease-out duration-300  ">
          <i className="fa-solid fa-eye text-[#696969]"></i>
          <p className="text-[#696969]">28765</p>
        </div>
        <div className="flex items-center justify-center rounded-[10px_0px_0px_10px] bg-[rgba(217,217,217,0.1)] backdrop-blur-sm w-[200px] h-[51px] group-hover:translate-y-[-76px] translate-y-[55px] ease-out duration-300  ">
          <img
...
export default BlogsCardsClient;
