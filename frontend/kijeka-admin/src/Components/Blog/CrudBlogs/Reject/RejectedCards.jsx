...
const RejectedCards = () => {
  ...
  return (
    <>
      <div className="flex flex-col group w-[474px] overflow-hidden h-[229px] rounded-[10px] bg-[#FFFFFF] shadow-[0px_4px_20px_rgba(166,166,166,0.5)] border-[2px] hover:border-[#E52F2F]  ">
